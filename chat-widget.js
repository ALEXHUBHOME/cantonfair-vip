...
const knowledgeBase = [
  ...
  // ========== 展期和产品分类 ==========
  {keywords: ["家电", "电子", "电器", "电气", "机械", "设备", "建材", "化工", "摩托车", "汽车配件", "home appliance", "appliances", "electronics", "machinery", "建材", "chemical"], answer: "这些产品在**第一期**（4月15-19日/10月15-19日），位于A区展馆。"},
  {keywords: ["陶瓷", "餐厨", "厨房", "家居", "装饰", "礼品", "工艺", "玩具", "宠物", "园林", "ceramic", "kitchen", "home", "gift", "toy"], answer: "这些产品在**第二期**（4月23-27日/10月23-27日），位于B区展馆。"},
  {keywords: ["服装", "纺织", "面料", "家纺", "服饰", "textile", "fabric", "garment", "fashion", "apparel", "服装"], answer: "纺织服装在**第二期和第三期**，位于C区展馆。"},
  {keywords: ["食品", "农产品", "医药", "医疗器械", "药品", "保健", "food", "agriculture", "pharma", "medical"], answer: "这些产品在**第三期**（4月底-5月初/10月底-11月初），位于D区展馆。"},
  {keywords: ["鞋", "箱包", "文具", "办公", "shoes", "bag", "luggage", "stationery", "office"], answer: "这些产品在**第三期**，位于D区展馆。"},
  {keywords: ["展期", "第几期", "哪一期", "产品分类", "phase", "when", "exhibit", "exhibition"], answer: "广交会每届分三期：第一期（电子机械建材）、第二期（家居礼品陶瓷）、第三期（食品纺织医疗）。请问您想找什么产品？"},
